...
LOCK TABLES `computing` WRITE;
/*!40000 ALTER TABLE `computing` DISABLE KEYS */;
INSERT INTO `computing` VALUES (1,'Bằng A'),(2,'Bằng B'),(3,'Bằng C');
/*!40000 ALTER TABLE `computing` ENABLE KEYS */;
UNLOCK TABLES;
