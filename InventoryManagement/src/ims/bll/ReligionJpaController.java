...
public class ReligionJpaController implements Serializable {
    ...
    public void create(Religion religion) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findReligion(religion.getId()) != null) {
                throw new PreexistingEntityException("Religion " + religion + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
