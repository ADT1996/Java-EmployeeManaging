...
public class EmployeePositionJpaController implements Serializable {
    ...
    public void create(EmployeePosition employeePosition) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findEmployeePosition(employeePosition.getId()) != null) {
                throw new PreexistingEntityException("EmployeePosition " + employeePosition + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
