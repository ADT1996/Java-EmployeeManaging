...
public class TypestaffJpaController implements Serializable {
    ...
    public void create(Typestaff typestaff) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findTypestaff(typestaff.getId()) != null) {
                throw new PreexistingEntityException("Typestaff " + typestaff + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
