...
public class DeparmentJpaController implements Serializable {
    ...
    public void create(Deparment deparment) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findDeparment(deparment.getId()) != null) {
                throw new PreexistingEntityException("Deparment " + deparment + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
