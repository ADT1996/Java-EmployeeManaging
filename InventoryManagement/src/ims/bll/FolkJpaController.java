...
public class FolkJpaController implements Serializable {
    ...
    public void create(Folk folk) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findFolk(folk.getId()) != null) {
                throw new PreexistingEntityException("Folk " + folk + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
