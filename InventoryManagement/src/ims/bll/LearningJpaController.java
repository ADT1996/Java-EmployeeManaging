...
public class LearningJpaController implements Serializable {
    ...
    public void create(Learning learning) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findLearning(learning.getId()) != null) {
                throw new PreexistingEntityException("Learning " + learning + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
