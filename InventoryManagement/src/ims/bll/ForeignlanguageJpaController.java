...
public class ForeignlanguageJpaController implements Serializable {
    ...
    public void create(Foreignlanguage foreignlanguage) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findForeignlanguage(foreignlanguage.getId()) != null) {
                throw new PreexistingEntityException("Foreignlanguage " + foreignlanguage + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
