...
public class NationalityJpaController implements Serializable {
    ...
    public void create(Nationality nationality) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findNationality(nationality.getId()) != null) {
                throw new PreexistingEntityException("Nationality " + nationality + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
