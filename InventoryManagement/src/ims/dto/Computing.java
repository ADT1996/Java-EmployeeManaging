...
@NamedQueries({
    ...
    , @NamedQuery(name = "Computing.findById", query = "SELECT c FROM Computing c WHERE c.id = :id")
    , @NamedQuery(name = "Computing.findByComputing", query = "SELECT c FROM Computing c WHERE c.computing = :computing")})
